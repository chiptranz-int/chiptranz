                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="list d-flex align-items-center border-bottom pb-3">
                                            <img class="img-sm rounded-circle" src="../../images/faces/face8.jpg"
                                                 alt="">
                                        ...
                                        <div class="list d-flex align-items-center pt-3">
                                            <img class="img-sm rounded-circle" src="../../images/faces/face9.jpg"
                                                 alt="">
                                            <div class="wrapper w-100 ml-3">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mt-5">
                                            ...
                                            <p class="card-description mb-5">Traffic through the sources google and
                                                facebook
                                                for the day</p>
                                        </div>
                                        ...
                                        <div class="d-flex table-responsive">
                                            <div class="btn-group mr-2">
                                                <button class="btn btn-sm btn-primary"><i
                                                            class="mdi mdi-plus-circle-outline"></i> Add
                                                </button>
                                            </div>
                                            <div class="btn-group mr-2">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <p class="card-description">Products that are creating the most revenue and
                                            their
                                            sales
                                            throughout the year and the variation in behavior of sales.</p>
            ...
            <!-- content-wrapper ends -->
                ...
                <footer class="footer">
                    ...
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2019 <a
                                href="https://www.chiptranz.com" target="_blank">ChipTranz Integrated</a>.
                        All rights reserved.
                    </span>
