...
@section('main')
    <div class="row grid-margin">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Steady Growth Plans</h4>
                    <div class="d-flex table-responsive">
                        <div class="btn-group mr-2">
                            <a href="{{url('plans/steady?item=all')}}">
                                <button class="btn btn-sm btn-primary @if($type=='all')bg-light text-dark @endif">All
                                    Plans
                                </button>
                            </a>

                            <a href="{{url('plans/steady?item=active')}}">
                            ...
                            <a href="{{url('plans/steady?item=expired')}}">
                        ...
                        <table class="table mt-3 border-top">
                            ...
                            @foreach($plans as $plan)
                                <tr>
                                    ...
                                    <td><a title="Plan Savings History" href="{{url('plans/steady-savings-history/'.$plan['id'].'/'.$plan['user_id'])}}" class="btn btn-info"><i class="mdi mdi-history"></i></a></td>
                                </tr>
                            @endforeach
