...
class SteadyGrowth extends Component {
    ...
    constructor(props) {
        ...
        this.retrieveSteadySavings = this.retrieveSteadySavings.bind(this);
    ...
    retrieveUserInfo() {
        ...
        axios.get(this.domain.getDomain() + this.domain.steadyPlan()).then(function (response) {
    ...
    retrieveSteadySavings() {
        axios.get(this.domain.getDomain() + this.domain.steadySavings(this.state.currentPlan.id)).then(function (response) {
            ...
            if (response.status == 200) {
                ...
                this.setState({
                    ...
                    steadySavings: response.data.steadySavings,
    ...
    handleSubmit(e) {
        ...
        axios({
            method: 'post',
            url: this.domain.getDomain() + this.domain.updateSteadyGrowth(),
            data: form,
        ...
        if (this.state.steady[0] != null) {
            ...
            return (
                ...
                <div className="col-12 row">
                    ...
                    {this.state.steady.map(function (plan) {
                        return (
                    ...
                    <div className="card col-lg-7 col-md-6 grid-margin overflow-auto p-3">
                        ...
                        <div className="table-responsive">
                            <table className="table table-striped table-sm">
                                ...
                                <tbody>
                                {this.state.steadySavings.map(function (savings) {
                    ...
                    <div className="card-body">
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <input type="date"
                                           value={this.state.currentPlan.next_savings == null ? '' : this.state.currentPlan.next_savings}
