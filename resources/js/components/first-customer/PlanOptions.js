...
import YouthOption from '../first-customer/YouthOption'
import SteadyOption from '../first-customer/SteadyOption'
...
class PlanOptions extends Component {
    ...
    getPage() {
        switch (this.state.page) {
            ...
            case 1:
                return (<YouthOption user={this.state.user} />);
                                    ...
                                    <div className="card  col-lg-12 col-md-12 grid-margin ">
                                        ...
                                        <div className="card text-dark  card-shadow-primary">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <p className="h4 font-weight-normal">Open your first Savings Account
                                                    with
                                                    ChipTranz, select a plan to begin</p>
                                        ...
                                        <div className="card">
                                            <div className="card-body">
                                                ...
                                                <div className="list d-flex align-items-center border-bottom py-3">
                                                    ...
                                                    <div className="wrapper w-100 ml-3">
                                                        <p><b>Liquidation after 12 months </b></p>
