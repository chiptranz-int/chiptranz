...
import PlanHelper from '../customer/savings/PlanHelper';
...
class PlanPageNavigator extends Component {
    ...
    getNextThrityDays() {
        ...
        let month = this.getFullDay(newDate.getMonth() + 3);
    ...
    updateNextThirtyDay(from) {

        let date = from.split("-");
        let newDate = new Date(date[0], parseInt(date[1]) - 1, (parseInt(date[2]) + 90));
        let year = newDate.getFullYear();
    ...
    handleDurationFromChange(evt) {
        ...
        this.updateNextThirtyDay(evt.target.value);
    }
            ...
            <div>
                <form onSubmit={this.handleCardSubmit}>
                    ...
                    <div className="list text-center d-flex align-items-center border-bottom py-3">
                        ...
                        <div className="wrapper w-100 ml-3">
                            <div className="text-right">
                                <button type="button" onClick={this.handleAddNewCard} className="btn btn-info">Add a New Card
                                ...
                                <div className="card-body">
                                    <div className="d-flex justify-content-between">
                                        <h3 className="card-title">
                                            <i className="fa fa-users text-primary fa-2x"></i> Youth Goals</h3>
                                    </div>
                                    {this.planComponent()}
